...
-- Int64# signed ops
  ...
  Int64ToInt     -> \args -> opTranslate64 args (\w -> MO_SS_Conv w (wordWidth platform)) MO_64_S_Conv_ToNative
  IntToInt64     -> \args -> opTranslate64 args (\w -> MO_SS_Conv (wordWidth platform) w) MO_64_S_Conv_FromNative
...
-- Word64# unsigned ops
  ...
  Word64ToWord   -> \args -> opTranslate64 args (\w -> MO_UU_Conv w (wordWidth platform)) MO_64_U_Conv_ToNative
  WordToWord64   -> \args -> opTranslate64 args (\w -> MO_UU_Conv (wordWidth platform) w) MO_64_U_Conv_FromNative
